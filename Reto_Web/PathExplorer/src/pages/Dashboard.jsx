        ...
        >
          <Box>
            ...
            <Typography variant="body1">
              Tienes 2 certificaciones próximas a vencer y 3 actividades programadas para este mes.
            </Typography>
          </Box>
          <Box sx={{ mt: { xs: 2, md: 0 } }}>
            <Button 
    ...
    return (
      <Box sx={{ p: 4, bgcolor: "#f0f0f0" }}>
        ...
        <Typography variant="body2" sx={{ mt: 2 }}>
          Por favor, verifica la consola para más detalles e intenta recargar la página.
        </Typography>
      </Box>
    );
  }
