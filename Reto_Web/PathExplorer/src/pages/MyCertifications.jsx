...
const elegantButtonStyles = (theme) => ({
  primary: {
    borderRadius: 8,
    fontWeight: 500,
  ...
  outline: {
    ...
    "&:hover": {
      borderColor: theme.palette.accenture.colors.accentPurple3,
      backgroundColor: alpha(theme.palette.accenture.colors.corePurple1, 0.05),
    },
  },
  text: {
    textTransform: "none",
...
const elegantChipStyles = (theme) => ({
  approved: {
    bgcolor: alpha(theme.palette.states.success, 0.08),
    color: theme.palette.states.success,
    borderColor: alpha(theme.palette.states.success, 0.2),
    "& .MuiChip-icon": {
      color: theme.palette.states.success,
    },
  },
  pending: {
    bgcolor: alpha(theme.palette.states.warning, 0.08),
    color: theme.palette.states.warning,
    borderColor: alpha(theme.palette.states.warning, 0.2),
    "& .MuiChip-icon": {
      color: theme.palette.states.warning,
    },
  },
  rejected: {
    bgcolor: alpha(theme.palette.states.error, 0.08),
...
const MyCertifications = () => {
  ...
  const getCurrentUserId = () => {
    ...
    return supabase.auth
      .getUser()
      .then(({ data }) => data.user?.id || "current-user-id");
  };
  ...
  useEffect(() => {
    ...
    const processCertifications = (certs) => {
      ...
      const processedCerts = certs.map((cert) => ({
        ...
        certification: {
          ...
          certification_Image:
            cert.certification?.certification_Image ||
            getDefaultImageByType(cert.certification?.type),
      ...
      const countByStatus = processedCerts.reduce(
        (acc, cert) => {
    ...
    const getDefaultImageByType = (type) => {
      const typeImageMap = {
        "Project Management":
          "https://img-c.udemycdn.com/course/750x422/2806490_5db0.jpg",
        "Cloud Computing":
        ...
        Leadership:
          "https://media.licdn.com/dms/image/D5612AQEZ9MmzDX0Quw/article-cover_image-shrink_600_2000/0/1655660612362?e=2147483647&v=beta&t=HANgb1jU-vKOK4L_fUDFPqz_FVjNg-8XKY3BONvObs4",
        Cybersecurity:
          "https://img-c.udemycdn.com/course/750x422/614772_233b_9.jpg",
        "Human Resources":
          "https://www.shrm.org/adobe/dynamicmedia/deliver/dm-aid--f30d95fb-cf54-463f-8557-eb68a1b0065a/shrm-cp-badge.png",
      };
  ...
  useEffect(() => {
    ...
    if (activeTab !== "all") {
      filtered = filtered.filter(
        (cert) => cert.status?.toLowerCase() === activeTab
      );
    }
  ...
  const sortCertifications = (certs, sortMethod) => {
    switch (sortMethod) {
      case "newest":
        return [...certs].sort(
          (a, b) =>
            new Date(b.completed_Date || 0) - new Date(a.completed_Date || 0)
        );
      case "oldest":
        return [...certs].sort(
          (a, b) =>
      ...
      case "a-z":
        return [...certs].sort((a, b) =>
          a.certification.title.localeCompare(b.certification.title)
        );
      case "z-a":
        return [...certs].sort((a, b) =>
          b.certification.title.localeCompare(a.certification.title)
        );
      default:
        return certs;
    }
  ...
  const getStatusIcon = (status) => {
    switch (status?.toLowerCase()) {
      case "approved":
        return (
          <CheckCircleIcon
            sx={{ color: theme.palette.states.success, fontSize: 20 }}
          />
        );
      case "pending":
        return (
          <PendingIcon
            sx={{ color: theme.palette.states.warning, fontSize: 20 }}
          />
        );
      case "rejected":
        return (
      ...
      default:
        return (
          <ErrorOutlineIcon
            sx={{ color: theme.palette.text.primary.secondary, fontSize: 20 }}
          />
        );
    }
  };
      ...
      <Box sx={{ width: "100%", p: { xs: 2, md: 4 } }}>
        <Paper
          ...
          sx={{
            ...
            border: "1px solid",
            borderColor: alpha(theme.palette.states.error, 0.2),
            bgcolor: alpha(theme.palette.states.error, 0.03),
            boxShadow: `0 10px 30px ${alpha(theme.palette.states.error, 0.05)}`,
          }}
        >
          <Box
            sx={{
              ...
              alignItems: "center",
              justifyContent: "center",
              bgcolor: alpha(theme.palette.states.error, 0.1),
              mx: "auto",
              mb: 3,
            }}
          >
            <ErrorOutlineIcon
              sx={{ fontSize: 40, color: theme.palette.states.error }}
            />
          </Box>
          <Typography
            variant="h5"
          ...
          <Button
            variant="contained"
            sx={{
              ...elegantButtonStyles(theme).primary,
  ...
  const sortOptions = [
    {
      value: "newest",
      label: "Newest First",
      icon: <ArrowBackIcon sx={{ transform: "rotate(-90deg)" }} />,
    },
    {
      value: "oldest",
      label: "Oldest First",
    ...
    { value: "a-z", label: "A-Z", icon: <SortIcon /> },
    {
      value: "z-a",
      label: "Z-A",
      icon: <SortIcon sx={{ transform: "scaleY(-1)" }} />,
    },
  ];
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <IconButton
            ...
            sx={{
              color: theme.palette.accenture.colors.corePurple1,
              bgcolor: alpha(theme.palette.accenture.colors.corePurple1, 0.1),
              height: 44,
              width: 44,
              "&:hover": {
                bgcolor: alpha(
        ...
        <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
          <Button
            ...
            sx={{
              ...
              height: 44,
              "&:hover": {
                bgcolor: theme.palette.accenture.colors.accentPurple3,
              },
            }}
          ...
          <Tab
            label={
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <CheckCircleIcon
                  fontSize="small"
                  sx={{ color: theme.palette.states.success, fontSize: 16 }}
                />
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    minWidth: 20,
                    fontSize: "0.75rem",
                    bgcolor: alpha(theme.palette.states.success, 0.1),
                    color: theme.palette.states.success,
                    fontWeight: 600,
                  }}
                />
          ...
          <Tab
            label={
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <PendingIcon
                  fontSize="small"
                  sx={{ color: theme.palette.states.warning, fontSize: 16 }}
                />
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    minWidth: 20,
                    fontSize: "0.75rem",
                    bgcolor: alpha(theme.palette.states.warning, 0.1),
                    color: theme.palette.states.warning,
                    fontWeight: 600,
                  }}
                />
          ...
          <Tab
            label={
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <CancelIcon
                  fontSize="small"
                  sx={{ color: theme.palette.states.error, fontSize: 16 }}
                />
                ...
                >
                  ...
                  <Box
                    sx={{
                      position: "relative",
                      height: 140,
                      background: `linear-gradient(135deg, ${theme.palette.accenture.colors.accentPurple1}, ${theme.palette.accenture.colors.accentPurple3})`,
                      display: "flex",
                      flexDirection: "column",
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        opacity: 0.07,
                        background:
                          "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='1' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3Ccircle cx='13' cy='13' r='1.5'/%3E%3C/g%3E%3C/svg%3E\")",
                      }}
                    />
                    ...
                    {cert.status === "rejected" && cert.rejection_reason && (
                      <Box
                        sx={{
                          ...
                          borderRadius: 2,
                          border: "1px solid",
                          borderColor: alpha(theme.palette.states.error, 0.1),
                          display: "flex",
                          gap: 1,
                          mb: 2,
                        }}
                      >
                        ...
                        <Typography
                          variant="body2"
                          sx={{
                            color: alpha(theme.palette.states.error, 0.9),
                            fontSize: "0.8rem",
                            lineHeight: 1.5,
                          }}
                        >
                      ...
                      <Box sx={{ display: "flex", gap: 1 }}>
                        ...
                        {cert.status === "rejected" && (
                          <Button
                            ...
                            sx={{
                              ...elegantButtonStyles(theme).outline,
                              height: 32,
                              fontSize: "0.75rem",
                              borderColor: alpha(
                                theme.palette.accenture.colors.corePurple1,
        ...
        <Fade in={evidenceModalOpen}>
          <Paper
            ...
            sx={{
              ...
              position: "relative",
              boxShadow: `0 20px 80px -12px ${alpha(
                theme.palette.accenture.colors.corePurple1,
                0.35
              )}`,
              display: "flex",
            ...
            >
              {selectedEvidence && selectedEvidence.endsWith(".pdf") ? (
                ...
                >
                  ...
                  >
                    The evidence for this certification is available at the
                    following URL:
                  </Typography>
                  <Link
