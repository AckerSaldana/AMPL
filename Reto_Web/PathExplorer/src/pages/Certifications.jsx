...
const fallbackCertifications = [
  ...
  },
  {
    ...
    backgroundImage:
      "https://d1.awsstatic.com/training-and-certification/certification-badges/AWS-Certified-Solutions-Architect-Associate_badge.3419559c4ef4d0693bff300b6e5fb80f4f8e7c48.png",
  },
  {
    ...
    backgroundImage:
      "https://d3njjcbhbojbot.cloudfront.net/adobe/dynamicmedia/deliver/dm-aid--f30d95fb-cf54-463f-8557-eb68a1b0065a/shrm-cp-badge.png",
  },
  {
...
const Certifications = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (
          ...
          Date.now() - certificationsCache.timestamp <
            certificationsCache.CACHE_DURATION
        ) {
          const { processedCerts, skillNames, uniqueTypes } =
            certificationsCache.data;
        ...
        if (skillsResponse.error)
          throw new Error(
            `Error loading skills: ${skillsResponse.error.message}`
          );
        if (certsResponse.error)
          throw new Error(
            `Error loading certifications: ${certsResponse.error.message}`
          );
        ...
        const uniqueTypes = [
          "all",
          ...new Set(processedCerts.map((cert) => cert.type).filter(Boolean)),
        ];
    ...
    const setupFallbackData = () => {
      ...
      const uniqueTypes = [
        "all",
        ...new Set(fallbackCertifications.map((cert) => cert.type)),
      ];
      setCategories(uniqueTypes);
        ...
        <Box sx={{ width: "100%", p: { xs: 2, md: 4 } }}>
          <Paper
            ...
            sx={{
              ...
              borderRadius: 2,
              border: "1px solid",
              borderColor: alpha(theme.palette.accenture.colors.black, 0.08),
            }}
          >
            <motion.div
              initial={{ rotate: 0 }}
          ...
          <TextField
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <SearchIcon
                    sx={{
                      color: alpha(theme.palette.accenture.colors.black, 0.4),
                    }}
                  />
                </InputAdornment>
              ),
            ...
            sx={{
              ...
              "& .MuiOutlinedInput-root": {
                borderRadius: 8,
                bgcolor: theme.palette.accenture.colors.white,
                transition: "all 0.2s",
                border: "1px solid",
                borderColor: alpha(theme.palette.accenture.colors.black, 0.1),
                "&:hover": {
                  borderColor: alpha(
          ...
          <Button
            ...
            sx={{
              ...
              bgcolor:
                activeFilterCount > 0
                  ? theme.palette.accenture.colors.corePurple1
                  : theme.palette.accenture.colors.white,
              color:
                activeFilterCount > 0
                  ? theme.palette.accenture.colors.white
                  : alpha(theme.palette.accenture.colors.black, 0.7),
              "&:hover": {
                borderColor:
                  activeFilterCount > 0
                    ? "transparent"
                ...
                bgcolor:
                  activeFilterCount > 0
                    ? theme.palette.accenture.colors.corePurple2
                    : alpha(theme.palette.accenture.colors.corePurple1, 0.05),
              },
              transition: "all 0.2s",
              px: 2,
              height: 40,
          ...
          <ClickAwayListener onClickAway={closeFilters}>
            <MotionBox
              ...
              sx={{
                ...
                overflow: "hidden",
                boxShadow:
                  "0 8px 32px rgba(0, 0, 0, 0.12), 0 0 2px rgba(0, 0, 0, 0.08)",
                border: "1px solid",
                borderColor: alpha(theme.palette.accenture.colors.black, 0.06),
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                  ...
                  <Typography
                    variant="subtitle1"
                    fontWeight={700}
                    color={alpha(theme.palette.accenture.colors.black, 0.8)}
                  >
                  ...
                  {skillFilter.length > 0 && (
                    ...
                    >
                      <Typography
                        variant="caption"
                        fontWeight={600}
                        color={alpha(theme.palette.accenture.colors.black, 0.7)}
                ...
                {activeFilterCount > 0 && (
                  <Box
                    sx={{
                      ...
                      bgcolor: alpha(theme.palette.accenture.colors.white, 0.5),
                      mx: -3,
                      px: 3,
                      pb: 2,
                    }}
          ...
          <Fade in={animationReady} timeout={600}>
            <Paper
              ...
              sx={{
                ...
                borderRadius: 2,
                border: "1px dashed",
                borderColor: alpha(theme.palette.accenture.colors.black, 0.12),
                bgcolor: theme.palette.background.paper,
            ...
            >
              ...
              >
                <SchoolIcon
                  sx={{
                    fontSize: 48,
                    color: alpha(theme.palette.accenture.colors.black, 0.2),
                    mb: 2,
                  }}
                />
              </motion.div>
