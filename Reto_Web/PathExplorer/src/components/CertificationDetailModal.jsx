            ...
            >
              <Box
                sx={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  bgcolor: alpha(theme.palette.accenture.colors.red, 0.08),
                  color: theme.palette.accenture.colors.red,
                  mx: "auto",
                  mb: 3,
                }}
              >
              ...
              >
                There was a problem retrieving this certification. Please try
                again later.
              </Typography>
              <Button
                variant="outlined"
                ...
                >
                  ...
                  {certification.url && (
                    <Button
                      ...
                      sx={{
                        background: `linear-gradient(135deg, ${theme.palette.accenture.colors.corePurple1} 0%, ${theme.palette.accenture.colors.corePurple2} 100%)`,
                        borderRadius: "30px",
                        px: 3,
                        py: 0.75,
                        textTransform: "none",
                        ...
                        "&:hover": {
                          ...
                          background: `linear-gradient(135deg, ${theme.palette.accenture.colors.corePurple1} 0%, ${theme.palette.accenture.colors.corePurple2} 70%)`,
                        },
