  ...
  const generateCalendarDays = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      currentMonthDays.push({
        ...
        isCurrentMonth: true,
        isToday:
          currentMonth.date(i).format("YYYY-MM-DD") ===
        ...
        hasDeadline: projectReminders.some(
          (project) =>
            project.endDate === currentMonth.date(i).format("YYYY-MM-DD")
        ),
      ...
      case "medium":
        return (
          <FlagIcon
            sx={{
              fontSize: iconSize,
              color: theme.palette.accenture.colors.orange,
            }}
          />
        );
      case "low":
        return (
          <LowPriorityIcon
            sx={{
              fontSize: iconSize,
              color: theme.palette.accenture.colors.green,
            }}
          />
        );
      default:
