          ...
          <IconButton 
            ...
            sx={{ 
              ...
              '&::after': {
                ...
                background: `radial-gradient(circle at center, ${alpha(primaryColor, 0.2)} 0%, transparent 70%)`,
                pointerEvents: 'none'
              },
              '&:active::after': {
                opacity: 1
          ...
          >
            <Box 
              sx={{ 
                ...
                transition: 'transform 0.5s cubic-bezier(0.68, -0.55, 0.27, 1.55)' // Rebote suave
              }}
            >
          ...
          <IconButton 
            ...
            sx={{ 
              ...
              '&::after': {
                ...
                opacity: 0,
                transition: 'opacity 0.3s ease',
                background: `radial-gradient(circle at center, ${darkMode ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.1)'} 0%, rgba(0,0,0,0) 70%)`,
                pointerEvents: 'none'
              },
              '&:active::after': {
                opacity: 1
          ...
          <IconButton 
            ...
            sx={{ 
              ...
              '&::after': {
                ...
                opacity: 0,
                transition: 'opacity 0.3s ease',
                background: `radial-gradient(circle at center, ${darkMode ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.1)'} 0%, transparent 70%)`,
                pointerEvents: 'none'
              },
              '&:active::after': {
                opacity: 1
              ...
              >
                <ListItem 
                  ...
                  sx={{
                    ...
                    borderRadius: '10px',
                    bgcolor: activeItem === item.text 
                      ? primaryColor 
                      : 'transparent',
                    color: activeItem === item.text ? 'white' : 'inherit',
                    boxShadow: activeItem === item.text 
                      ? `0 4px 10px ${alpha(primaryColor, 0.3)}` 
                      : 'none',
                    transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                    transform: hoveredItem === item.text && activeItem !== item.text 
                      ? 'translateY(-3px)' 
                      : 'translateY(0)',
                    position: 'relative',
                    overflow: 'hidden',
                ...
                >
                  ...
                  {activeItem === item.text && rippleActive && <RippleEffect active={rippleActive} />}
